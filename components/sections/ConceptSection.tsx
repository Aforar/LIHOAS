...
export const ConceptSection = () => {
    ...
    return (
        <section id="about" className="relative py-24 md:py-32 bg-green-950 text-white overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <ScrollElement direction="left" delay={0.4}>
                            <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif leading-tight mb-6 md:mb-8" dangerouslySetInnerHTML={{ __html: t.raw('title') }} />
                        </ScrollElement>
                    ...
                    <ScrollElement direction="up" delay={0.5} className="h-[400px] md:h-[550px] w-full relative group mt-8 lg:mt-0">
